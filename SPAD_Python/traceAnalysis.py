...
def ReadTwoROItrace (dpath,plot_xrange=500):
    ...
    plot_trace(Green_raw[0:plot_xrange],ax, fs=9938.4, label="Green data trace")
    fig, ax = plt.subplots(figsize=(12, 2.5))
    plot_trace(Red_raw[0:plot_xrange],ax, fs=9938.4, label="Red data trace")
...
def DemodTwoTraces (Green_raw, Red_raw):
    ...
    lmin,lmax=SPADdemod.Find_targetPeaks(Red_raw, dmin=1, dmax=1,high_limit=1500, low_limit=1000)
    fig, ax = plt.subplots(figsize=(12, 3))
