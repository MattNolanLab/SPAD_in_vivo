...
% Open OK comms
okComms.ptr = calllib('okFrontPanel', 'okUsbFrontPanel_Construct');
end
...
% Serial Number:
sn = getserialnumber(okComms);
fpga = openbyserial(okComms, sn);
