...
%data bit-planes
ddir1='C:\Users\igyongy2\Desktop\CSS\Devices\SPCIMAGER_AA_USB3\Opal Kelly\ulens_back'; %path where files reside
%ddir1='C:\Users\igyongy2\Desktop\ulens\back_n'; %path where files reside
ddir2='C:\Users\igyongy2\Desktop\CSS\Devices\SPCIMAGER_AA_USB3\Opal Kelly\ulens_signal_red'; %path where files reside
dfile='data'; %name of the files (excluding the numbering)
...
plot(Erange,out_nl(33,:)/1000,'-*');
hold on;
plot(Erange,out_l(33,:)/1000,'-+');
