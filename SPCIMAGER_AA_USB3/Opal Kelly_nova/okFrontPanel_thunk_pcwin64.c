/* C thunk file for functions in okFrontPanel_proto.m generated on Thu Apr  9 10:19:52 2015. */
...
/*  okDeviceSensors_HANDLE __stdcall okDeviceSensors_Construct (); */
EXPORT_EXTERN_C void * voidPtrThunk(void fcn(),const char *callstack,int stacksize)
{
	return ((void * (*)( ))fcn)();
}

/*  void __stdcall okDeviceSensors_Destruct ( okDeviceSensors_HANDLE hnd ); */
...
/*  int __stdcall okDeviceSensors_GetSensorCount ( okDeviceSensors_HANDLE hnd ); */
...
/*  okTDeviceSensor __stdcall okDeviceSensors_GetSensor ( okDeviceSensors_HANDLE hnd , int n ); */
EXPORT_EXTERN_C okTDeviceSensor okTDeviceSensorvoidPtrint32Thunk(void fcn(),const char *callstack,int stacksize)
{
	void * p0;
	int32_T p1;
	p0=*(void * const *)callstack;
	...
	p1=*(int32_T const *)callstack;
	callstack+=sizeof(p1) % sizeof(size_t) ? ((sizeof(p1) / sizeof(size_t)) + 1) * sizeof(size_t):sizeof(p1);
	return ((okTDeviceSensor (*)(void * , int32_T ))fcn)(p0 , p1);
}
...
/*  ok_ErrorCode __stdcall okFrontPanel_AddCustomDevice ( const okTDeviceMatchInfo * matchInfo , const okTDeviceInfo * devInfo ); */
...
/*  ok_ErrorCode __stdcall okFrontPanel_RemoveCustomDevice ( int productID ); */
EXPORT_EXTERN_C ok_ErrorCode ok_ErrorCodeint32Thunk(void fcn(),const char *callstack,int stacksize)
{
	int32_T p0;
	p0=*(int32_T const *)callstack;
	callstack+=sizeof(p0) % sizeof(size_t) ? ((sizeof(p0) / sizeof(size_t)) + 1) * sizeof(size_t):sizeof(p0);
	return ((ok_ErrorCode (*)(int32_T ))fcn)(p0);
}
...
/*  ok_ErrorCode __stdcall okFrontPanel_GetDeviceSensors ( okFrontPanel_HANDLE hnd , okDeviceSensors_HANDLE settings ); */
...
/*  okCFrontPanelManager_HANDLE __stdcall okFrontPanelManager_Construct ( okFrontPanelManager_HANDLE self , const char * realm ); */
